  ...
  <div class="services" id="uslugi">
        ...
        <div class="container">
	      <div class="uslugi-buttons-panel">
	        <div class="container navbar-example">
		      <ul class="list-inline uslugi-buttons-small nav nav-tabs" role="tablist">
		        <li class="col-xs-3"><a href="#services-site-creating" name="services-site-creating" class="button-razrabotka-small active">Разработка</a></li>
		        <li class="col-xs-3"><a href="#services-site-accompaniment" name="services-site-accompaniment" class="button-soprovozhdenie-small">Сопровождение</a></li>
		        <li class="col-xs-3"><a href="#services-engineering" name="services-engineering" class="button-proektirovanie-small">Проектирование</a></li>
		        <li class="col-xs-3"><a href="#services-analitics" name="services-analitics" class="button-analitika-small">Аналитика</a></li>
		      </ul>
	        </div>
	      </div>
        </div>
    ...
    <div class="services-site-creating" id="services-site-creating">
      ...
      <div class="panel-black panel-tecnologies">
        ...
        <ul class="list-inline list-technologies">
          ...
          <li><span class="icon icon-css3"></span></li>
          <li><span class="icon icon-axure"></span></li>
    ...
    <div class="services-engineering" id="services-engineering">
      ...
      <div class="services-engineering-text">
        <div class="container">От того, насколько профессионально будет спроектирован сайт компании, зависит успешность и эффективность дальнейшей эксплуатации ресурса и та польза, которую он принесет его владельцу. Поэтому компания Webtrend комплексно подходит к реализации заказов по проектированию сайтов, выделяя для этого все необходимые ресурсы и лучшие возможности своей команды.</div>
      </div>
